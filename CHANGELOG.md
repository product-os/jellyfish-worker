...
* Update prettier to 3.0.2 [Josh Bowling]

## 51.0.16 - 2023-08-27

* Remove unused @types/bluebird [Josh Bowling]

## 51.0.15 - 2023-08-27

* Update just-permutations to 2.2.1 [Josh Bowling]
...
* Update sinon to 15.2.0 [Josh Bowling]

## 51.0.11 - 2023-08-27

* Update simple-git-hooks to 2.9.0 [Josh Bowling]

## 51.0.10 - 2023-08-27

* Update nock to 13.3.3 [Josh Bowling]

## 51.0.9 - 2023-08-27

* Update countries-and-timezones to 3.5.1 [Josh Bowling]

## 51.0.8 - 2023-08-27

* Update qs to 6.11.2 [Josh Bowling]

## 51.0.7 - 2023-08-26

* Update @types/semver to 7.5.0 [Josh Bowling]

## 51.0.6 - 2023-08-26

* Update lint-staged to 14.0.1 [Josh Bowling]

## 51.0.5 - 2023-08-26

* Update typed-error to 3.2.2 [Josh Bowling]

## 51.0.4 - 2023-08-26

* Update json-e to 4.5.3 [Josh Bowling]

## 51.0.3 - 2023-08-26

* Update bcrypt from 5.1.0 to 5.1.1 [Josh Bowling]
...
* Update autumndb to 26.0.4 [Josh Bowling]

## 51.0.0 - 2023-04-04

* Remove reactions [Josh Bowling]

## 50.0.0 - 2023-04-03

* Remove transformer relationships [Josh Bowling]

## 49.0.0 - 2023-04-03

* Remove task relationships [Josh Bowling]

## 48.0.0 - 2023-04-03

* Remove channel agent user relationship [Josh Bowling]
* Remove action-increment [Josh Bowling]
...
* Remove set-add and set-update actions [Josh Bowling]

## 46.0.0 - 2023-04-01

* Remove action-increment-tag [Josh Bowling]

## 45.0.0 - 2023-04-01

* Remove set-user-avatar action [Josh Bowling]

## 44.0.0 - 2023-04-01

* Remove triggered-action-matchmake-task [Josh Bowling]

## 43.0.0 - 2023-04-01

* Remove chart-configuration contract [Josh Bowling]

## 42.0.0 - 2023-04-01

* Remove scheduled actions [Josh Bowling]
...
* Remove working-hours contract [Josh Bowling]

## 39.0.0 - 2023-04-01

* Remove agent-channel-settings contract [Josh Bowling]

## 38.0.1 - 2023-04-01

* Update nock from 13.2.9 to 13.3.0 [Josh Bowling]

## 38.0.0 - 2023-03-31

* Remove Google Meet action [Josh Bowling]

## 37.16.5 - 2023-03-31

* Update typescript to v5 [Josh Bowling]
...
* Update autumndb to v22.8.1 [Josh Bowling]

## 37.16.1 - 2023-02-05

* Reduce number of event creations/links [Josh Bowling]
...
* Update dependency fast-equals to 4.0.3 [Renovate Bot]
...
* Update @balena/jellyfish-metrics from 2.0.294 to 2.0.296 [renovate[bot]]
...
* Update @balena/jellyfish-metrics from 2.0.292 to 2.0.294 [renovate[bot]]
...
* Update @balena/jellyfish-metrics from 2.0.291 to 2.0.292 [renovate[bot]]
...
* Update @balena/jellyfish-metrics from 2.0.289 to 2.0.291 [renovate[bot]]

## 37.1.8 - 2022-11-19

* Update cron-parser from 4.6.0 to 4.7.0 [renovate[bot]]
...
* Update @balena/jellyfish-assert from 1.2.102 to 1.2.103 [renovate[bot]]

## 37.1.5 - 2022-11-19

* Update @balena/jellyfish-environment from 14.6.8 to 14.6.10 [renovate[bot]]

## 37.1.4 - 2022-11-19

* Update @balena/jellyfish-metrics from 2.0.287 to 2.0.289 [renovate[bot]]
...
* Update @balena/jellyfish-assert from 1.2.100 to 1.2.102 [renovate[bot]]

## 37.1.1 - 2022-11-16

* Add query function to sync interfaces [Josh Bowling]

## 37.1.0 - 2022-11-16

* Expose query to sync context [Josh Bowling]
...
* Update @balena/jellyfish-metrics from 2.0.285 to 2.0.287 [renovate[bot]]
...
* Update @balena/jellyfish-metrics from 2.0.284 to 2.0.285 [renovate[bot]]
...
* Update @balena/jellyfish-jellyscript from 7.1.142 to 7.1.143 [renovate[bot]]
...
* Update @balena/jellyfish-environment from 14.4.7 to 14.4.10 [renovate[bot]]
...
* Stop creating creates/updates for external-events [Josh Bowling]
...
* Update @balena/jellyfish-jellyscript from 7.1.114 to 7.1.119 [renovate[bot]]
...
* Update @balena/jellyfish-jellyscript from 7.1.74 to 7.1.75 [renovate[bot]]
...
* Update @balena/jellyfish-environment from 13.0.13 to 14.0.0 [Josh Bowling]
...
* Fix skipped contracts on init [Josh Bowling]
...
* Update autumndb from 22.1.8 to 22.1.13 [renovate[bot]]
...
* Update @balena/jellyfish-logger from 5.1.22 to 5.1.24 [renovate[bot]]
...
* Allow external support users to read but not write relationships [Lucian Buzzo]
...
* Bring in channels [Josh Bowling]
...
* Update axios from 0.26.1 to 0.27.2 [Josh Bowling]
...
* Don't blindly replace contracts on bootstrap [Lucian Buzzo]
...
* Update autumndb from 19.1.40 to 19.3.0 [Renovate Bot]
...
* Update @balena/jellyfish-core from 16.0.7 to 16.0.9 [Josh Bowling]
...
* Remove unused js-combinatorics types package [Lucian Buzzo]
...
* Simplify test:integration npm script [Josh Bowling]
